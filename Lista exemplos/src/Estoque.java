//Questão 6 (Lista 01) - Jéssica Alves Batista - ADS 2018 IFBA
...
public class Estoque {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<5; i++) {
			pTotal = pTotal + vet_Preço[i];
			qtdTotal = qtdTotal + vet_QTD[i];
		}
		
		System.out.printf("/nO valor total do estoque é de R$ "+ pTotal);
		System.out.printf("\nA quantidade total em estoque é de "+ qtdTotal +" produtos.");
	}
